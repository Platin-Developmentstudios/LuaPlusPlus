...
#define PROGNAME	"program"		/* default program name */
#define OUTPUT		PROGNAME ".lppc"	/* default output file */
...
static int doargs(int argc, char* argv[])
{
 ...
 for (i=1; i<argc; i++)
 {
  ...
  else if (IS("-o"))			/* output file */
  {
   ...
   ++version;
  else if (IS("-r"))            /* show compiler info */
   printf("Compiler Files:\nCompiler Output Files are named program.lppc");
  else					/* unknown option */
   usage(argv[i]);
 }
